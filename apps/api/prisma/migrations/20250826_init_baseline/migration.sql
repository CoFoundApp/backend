...
-- CreateEnum
CREATE TYPE "public"."member_role" AS ENUM ('owner', 'admin', 'member', 'mentor');
...
-- CreateEnum
CREATE TYPE "public"."notification_type" AS ENUM ('system', 'message', 'project_invite', 'application_update', 'event_update', 'learning');
...
-- CreateIndex
CREATE UNIQUE INDEX "assistant_cache_cache_key_key" ON "public"."assistant_cache"("cache_key" ASC);

-- CreateIndex
CREATE INDEX "hnsw_assistant_cache_query" ON "public"."assistant_cache"("query_embedding" ASC);

-- CreateIndex
CREATE INDEX "idx_audit_actor" ON "public"."audit_log"("actor_user_id" ASC);

-- CreateIndex
CREATE INDEX "idx_audit_entity" ON "public"."audit_log"("entity_type" ASC, "entity_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "auth_identities_provider_provider_user_id_key" ON "public"."auth_identities"("provider" ASC, "provider_user_id" ASC);

-- CreateIndex
CREATE INDEX "idx_auth_identities_user" ON "public"."auth_identities"("user_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "badges_code_key" ON "public"."badges"("code" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "billing_webhook_events_event_id_key" ON "public"."billing_webhook_events"("event_id" ASC);

-- CreateIndex
CREATE INDEX "idx_conv_members_user" ON "public"."conversation_members"("user_id" ASC);

-- CreateIndex
CREATE INDEX "idx_conversations_project" ON "public"."conversations"("project_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "uq_course_module_position" ON "public"."course_modules"("course_id" ASC, "position" ASC);

-- CreateIndex
CREATE INDEX "hnsw_courses_embedding" ON "public"."courses"("embedding" ASC);

-- CreateIndex
CREATE INDEX "idx_courses_author" ON "public"."courses"("author_id" ASC);

-- CreateIndex
CREATE INDEX "idx_courses_fts" ON "public"."courses" USING GIN ("search_tsv" tsvector_ops ASC);

-- CreateIndex
CREATE UNIQUE INDEX "uq_enrollment_once" ON "public"."enrollments"("user_id" ASC, "course_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "uq_entitlement_feature" ON "public"."entitlements"("subscription_id" ASC, "feature_code" ASC);

-- CreateIndex
CREATE INDEX "idx_event_registrations_user" ON "public"."event_registrations"("user_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "uq_event_registration_once" ON "public"."event_registrations"("event_id" ASC, "user_id" ASC);

-- CreateIndex
CREATE INDEX "idx_event_sessions_event" ON "public"."event_sessions"("event_id" ASC);

-- CreateIndex
CREATE INDEX "hnsw_events_embedding" ON "public"."events"("embedding" ASC);

-- CreateIndex
CREATE INDEX "idx_events_fts" ON "public"."events" USING GIN ("search_tsv" tsvector_ops ASC);

-- CreateIndex
CREATE INDEX "idx_events_org" ON "public"."events"("organizer_id" ASC);

-- CreateIndex
CREATE INDEX "idx_events_time" ON "public"."events"("starts_at" ASC, "ends_at" ASC);

-- CreateIndex
CREATE INDEX "hnsw_interests_embedding" ON "public"."interests"("embedding" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "interests_name_key" ON "public"."interests"("name" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "interests_slug_key" ON "public"."interests"("slug" ASC);

-- CreateIndex
CREATE INDEX "idx_invoices_subscription" ON "public"."invoices"("subscription_id" ASC);

-- CreateIndex
CREATE INDEX "idx_jobs_queue_status" ON "public"."jobs"("queue" ASC, "status" ASC, "run_at" ASC);

-- CreateIndex
CREATE INDEX "idx_lesson_assets_lesson" ON "public"."lesson_assets"("lesson_id" ASC);

-- CreateIndex
CREATE INDEX "hnsw_lessons_embedding" ON "public"."lessons"("embedding" ASC);

-- CreateIndex
CREATE INDEX "idx_lessons_fts" ON "public"."lessons" USING GIN ("search_tsv" tsvector_ops ASC);

-- CreateIndex
CREATE UNIQUE INDEX "uq_lesson_position" ON "public"."lessons"("module_id" ASC, "position" ASC);

-- CreateIndex
CREATE INDEX "idx_msg_attachments_msg" ON "public"."message_attachments"("message_id" ASC);

-- CreateIndex
CREATE INDEX "hnsw_messages_embedding" ON "public"."messages"("embedding" ASC);

-- CreateIndex
CREATE INDEX "idx_messages_conv_time" ON "public"."messages"("conversation_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE INDEX "idx_messages_fts" ON "public"."messages" USING GIN ("search_tsv" tsvector_ops ASC);

-- CreateIndex
CREATE INDEX "idx_messages_sender" ON "public"."messages"("sender_id" ASC);

-- CreateIndex
CREATE INDEX "idx_notifications_user" ON "public"."notifications"("user_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "outbox_events_topic_aggregate_type_aggregate_id_created_at_key" ON "public"."outbox_events"("topic" ASC, "aggregate_type" ASC, "aggregate_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "plans_code_key" ON "public"."plans"("code" ASC);

-- CreateIndex
CREATE INDEX "idx_points_ledger_user" ON "public"."points_ledger"("user_id" ASC);

-- CreateIndex
CREATE INDEX "idx_privacy_consents_user" ON "public"."privacy_consents"("user_id" ASC);

-- CreateIndex
CREATE INDEX "hnsw_profiles_embedding" ON "public"."profiles"("embedding" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "profiles_user_id_key" ON "public"."profiles"("user_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "uq_progress_once" ON "public"."progress"("user_id" ASC, "lesson_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "uq_project_app_once" ON "public"."project_applications"("project_id" ASC, "applicant_id" ASC);

-- CreateIndex
CREATE INDEX "idx_project_members_user" ON "public"."project_members"("user_id" ASC);

-- CreateIndex
CREATE INDEX "hnsw_projects_embedding" ON "public"."projects"("embedding" ASC);

-- CreateIndex
CREATE INDEX "idx_projects_fts" ON "public"."projects" USING GIN ("search_tsv" tsvector_ops ASC);

-- CreateIndex
CREATE INDEX "idx_projects_owner" ON "public"."projects"("owner_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "uq_quiz_attempt_once" ON "public"."quiz_attempts"("quiz_id" ASC, "user_id" ASC, "started_at" ASC);

-- CreateIndex
CREATE INDEX "idx_quiz_questions_quiz" ON "public"."quiz_questions"("quiz_id" ASC);

-- CreateIndex
CREATE INDEX "idx_quizzes_course" ON "public"."quizzes"("course_id" ASC);

-- CreateIndex
CREATE INDEX "idx_quizzes_lesson" ON "public"."quizzes"("lesson_id" ASC);

-- CreateIndex
CREATE INDEX "idx_rec_feedback_target" ON "public"."recommendation_feedback"("target_type" ASC, "target_id" ASC);

-- CreateIndex
CREATE INDEX "idx_rec_feedback_user" ON "public"."recommendation_feedback"("user_id" ASC);

-- CreateIndex
CREATE INDEX "hnsw_resources_embedding" ON "public"."resources"("embedding" ASC);

-- CreateIndex
CREATE INDEX "idx_resources_author" ON "public"."resources"("author_id" ASC);

-- CreateIndex
CREATE INDEX "idx_resources_fts" ON "public"."resources" USING GIN ("search_tsv" tsvector_ops ASC);

-- CreateIndex
CREATE INDEX "hnsw_skills_embedding" ON "public"."skills"("embedding" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "skills_name_key" ON "public"."skills"("name" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "skills_slug_key" ON "public"."skills"("slug" ASC);

-- CreateIndex
CREATE INDEX "idx_user_interests_interest" ON "public"."user_interests"("interest_id" ASC);

-- CreateIndex
CREATE INDEX "idx_user_skills_skill" ON "public"."user_skills"("skill_id" ASC);
